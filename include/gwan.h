...
typedef struct
{
   ...
   u32      h_entity            :12, // 0-4096 (room for many HTTP headers,
            ...
            pipelined           : 1, // 0-1  (multiple requests were sent)
...
// Garbage collector
// ----------------------------------------------------------------------------
// NOTE: this memory CANNOT BE SHARED between connections and allocated
//       blocks are automatically deleted when a servlet returns.
// 
...
// that can be re-used in a loop or example; bonus: gc_free() does 
// not crash with double-free calls.
