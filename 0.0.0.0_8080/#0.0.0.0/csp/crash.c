...
//         crash():    35     05f952df   05f95344      017ae478      017ae478
//          main():    42     05f95344   00416355      017ae494      017ae478
// 
...
{
   char beg[1000]; // DEBUG MODE: helps to keep stack frames intact

   crash();        // choose your poison...

   char end[1000]; // DEBUG MODE: helps to keep stack frames intact
   beg[0] = end[0];
   end[0] = beg[0];
